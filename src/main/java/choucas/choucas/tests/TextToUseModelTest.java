...
import choucas.choucas.algorithm.TextToUseModelChain;
import choucas.utils.IoUtils;
import choucas.utils.WsUtils;

/**
 * Test application for Choucas text to use_model service chain adapter.
 *
 * @author Eric Gouardères
 * @date September 2021
 */

public class TextToUseModelTest 
{
    public static void main( String[] args )
    {
    	TextToUseModelChain service = new TextToUseModelChain();
        ...
        try {
	        ...
	        System.out.println( "--------------------------------" );
	        System.out.println( "Test : Calling Choucas text to use_model service chain" );
	        WsUtils.setStdoutFlag(false);
	        service.run();
	        System.out.println( "\n--------------------------------------");
	        System.out.println( "Test: Result of Choucas text to use_model service chain\n");
	        IoUtils.prettyPrintJson(service.getDataOutput());  
		} catch (IOException e) {
			// TODO Auto-generated catch block
			System.out.println( "Test: Error in calling Choucas text to use_model service chain\n");
			e.printStackTrace();
		}
}
}
