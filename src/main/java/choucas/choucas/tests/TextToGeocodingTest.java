...
import choucas.choucas.algorithm.TextToGeocodingChain;
...
public class TextToGeocodingTest 
{
    public static void main( String[] args )
    {
    	TextToGeocodingChain service = new TextToGeocodingChain();

    	String url = "";
    	String textFilePath = "C:\\Users\\gouarder\\Nuage\\Stage-CMI-BD\\Lot2\\Data\\temp\\test_nettoye_suivre.txt";
        ...
        try {
	        ...
	        System.out.println( "--------------------------------" );
	        System.out.println( "Test : Calling Choucas text to geocoding service chain" );
			...
			System.out.println( "Test: Error in calling Choucas text to geocoding service chain\n");
			e.printStackTrace();
		}
