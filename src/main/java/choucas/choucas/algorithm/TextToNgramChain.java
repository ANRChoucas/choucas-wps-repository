...
@Algorithm(version = "1.0.0", 
		title = "Text to Ngram Web Service chain process", 
		abstrakt = "Create ngram for a neural network processing. "
				+ "Provides JSON formatted text. "
				+ "Documentation : see  http://choucas.univ-pau.fr/docs for documentation on compound services : text_to_POS processing, create_ngram."
				)

public class TextToNgramChain extends AbstractAnnotatedAlgorithm {
	
	// private static final Logger log = LoggerFactory.getLogger(TextToNgram.class);	
    ...
    public void run() {
        ...
        File inputFile=null, posFile=null;
